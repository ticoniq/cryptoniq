...
export default function Example() {
  ...
  return (
    <>
      <header className="">
        <nav className="mx-auto flex items-center justify-between p-6 lg:px-8 bg-brightBlue text-white" aria-label="Global">
          <div className="flex">
            <button
              type="button"
          ...
          <div className="flex">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="uppercase">Cryptoniq</span>
            </a>
          </div>
          <div className="flex">
      ...
      <main className="">
        <div className="grid grid-cols-2 w-full">
          <div className="">
            <img src="https://th.bing.com/th/id/OIP.1YM53mG10H_U25iPjop83QHaEo?pid=ImgDet&rs=1" alt="" />
          </div>
          <div className="">
            <img src="https://th.bing.com/th/id/OIP.1YM53mG10H_U25iPjop83QHaEo?pid=ImgDet&rs=1" alt="" />
          </div>
